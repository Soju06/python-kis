...
class KisDomesticChartBar(KisChartBar):
    """한국투자증권 국내 차트 봉"""
...
class KisDomesticChart(KisResponse, KisChart):
    """한국투자증권 국내 차트"""

    bars: list[KisDomesticChartBar] = KisList(KisDomesticChartBar)["output2"]
    """차트"""
...
class KisOverseasChartBar(KisChartBar):
    """한국투자증권 해외 차트 봉"""
...
class KisOverseasChart(KisResponse, KisChart):
    """한국투자증권 국내 차트"""

    market_timing: KisOverseasTradingHours
    """장 운영 시간"""

    bars: list[KisOverseasChartBar] = KisList(KisOverseasChartBar)["output2"]
    """차트"""
