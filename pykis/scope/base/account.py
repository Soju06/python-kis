...
class KisAccountScope(KisMarketScope):
    ...
    def orderable_amount(
        ...
        Examples:
            ...
            >>> account.orderable_amount(stock, price=100, condition='extended', execution=None) # 국내 시간외단일가 매수
            ...
            >>> account.orderable_amount(stock, price=100, condition=None, execution='IOC') # 국내 IOC지정가 매수
            >>> account.orderable_amount(stock, price=100, condition=None, execution='FOK') # 국내 FOK지정가 매수
            >>> account.orderable_amount(stock, price=None, condition=None, execution='IOC') # 국내 IOC시장가 매수
            >>> account.orderable_amount(stock, price=None, condition=None, execution='FOK') # 국내 FOK시장가 매수
            >>> account.orderable_amount(stock, price=100, condition='best', execution='IOC') # 국내 IOC최유리 매수
            >>> account.orderable_amount(stock, price=100, condition='best', execution='FOK') # 국내 FOK최유리 매수
            >>> account.orderable_amount(stock, price=100, condition='LOO', execution=None) # 나스닥 장개시지정가 매수 (모의투자 지원안함)
            >>> account.orderable_amount(stock, price=100, condition='LOC', execution=None) # 나스닥 장마감지정가 매수 (모의투자 지원안함)
            >>> account.orderable_amount(stock, price=None, condition='MOO', execution=None) # 나스닥 장개시시장가 매수 (모의투자 지원안함)
            >>> account.orderable_amount(stock, price=None, condition='MOC', execution=None) # 나스닥 장마감시장가 매수 (모의투자 지원안함)
            >>> account.orderable_amount(stock, price=100, condition='LOO', execution=None) # 뉴욕 장개시지정가 매수 (모의투자 지원안함)
            >>> account.orderable_amount(stock, price=100, condition='LOC', execution=None) # 뉴욕 장마감지정가 매수 (모의투자 지원안함)
            >>> account.orderable_amount(stock, price=None, condition='MOO', execution=None) # 뉴욕 장개시시장가 매수 (모의투자 지원안함)
            >>> account.orderable_amount(stock, price=None, condition='MOC', execution=None) # 뉴욕 장마감시장가 매수 (모의투자 지원안함)
            >>> account.orderable_amount(stock, price=100, condition='LOO', execution=None) # 아멕스 장개시지정가 매수 (모의투자 지원안함)
            >>> account.orderable_amount(stock, price=100, condition='LOC', execution=None) # 아멕스 장마감지정가 매수 (모의투자 지원안함)
            >>> account.orderable_amount(stock, price=None, condition='MOO', execution=None) # 아멕스 장개시시장가 매수 (모의투자 지원안함)
            >>> account.orderable_amount(stock, price=None, condition='MOC', execution=None) # 아멕스 장마감시장가 매수 (모의투자 지원안함)
